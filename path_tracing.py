...
import numpy as np
import argparse
from ray_tracing_models import Ray, Camera, Hittable_list, Sphere, PI, random_in_unit_sphere, refract, reflect, reflectance, random_unit_vector, Box
ti.init(arch=ti.gpu)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--samples_per_pixel', type=int, default=5, help='samples_per_pixel  (default: 4)')
    parser.add_argument(
